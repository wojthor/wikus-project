import type { FinalCtaData } from "@/data/content";

type FinalCtaSectionProps = { data: FinalCtaData };
...
export function FinalCtaSection({ data }: FinalCtaSectionProps) {
  ...
  return (
    <section
      id="final-cta"
      className="relative w-full px-4 py-8 sm:px-6 sm:py-10 md:px-8 lg:px-12"
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mb-6 space-y-3">
          ...
          <div className="rounded-2xl border-2 border-[#7347f4] bg-[#cfd8ff] p-4 text-left sm:p-5">
            <p className="text-base font-bold text-[#243cb5] sm:text-lg">
              {data.option2}
            </p>
          </div>
        </div>
