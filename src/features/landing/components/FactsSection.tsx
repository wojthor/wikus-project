...
export function FactsSection() {
  return (
    <section
      id="fakty"
      className="min-h-[70vh] flex flex-col justify-center space-y-6 sm:space-y-8 py-8 sm:py-5 scroll-mt-1"
    >
      ...
      <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-start">
        <div className="space-y-4 text-base sm:text-lg leading-relaxed text-slate-600">
          ...
          <p>
            <AccentBrackets text="[Identyfikacja problemu] Gdy sam przeszedłem od zera do swobodnej rozmowy, zrozumiałem, że problem nie leży w braku talentu. Brakowało mi metody: konkretnych kroków, regularnej praktyki mówienia i materiałów dopasowanych do celu." />
          </p>
        </div>
