      ...
      <Section id="o-mnie" className="bg-white/50">
        ...
        >
          <div className={`${panel} flex flex-col`}>
            <p className={sectionEyebrow}>Czemu warto mnie posłuchać</p>
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-5xl mx-auto items-stretch">
          ...
          <div className="relative rounded-3xl border-2 border-[#7347f4] bg-gradient-to-br from-[#cfd8ff]/90 via-white to-[#f8faff] p-6 sm:p-10 shadow-[0_24px_60px_rgba(115,71,244,0.18)] ring-2 ring-[#7347f4]/15">
            ...
            <p className="text-xs text-slate-500 mt-4 text-center leading-relaxed">
              Bezpieczna płatność kartą lub Przelewy24. Po opłaceniu konto na platformie tworzy się
              automatycznie.
            </p>
          </div>
        </div>
      ...
      <Section id="faq">
        ...
        >
          {[
            ...
            {
              q: "Jak kupić kurs?",
              a: 'Kliknij przycisk „Chcę ten kurs” – przejdziesz na bezpieczną bramkę płatności Stripe (karta lub Przelewy24). Po opłaceniu konto na platformie tworzy się automatycznie, a hasło dostaniesz e-mailem w ciągu kilku minut.',
            },
          ].map((item) => (
            <motion.details
              key={item.q}
